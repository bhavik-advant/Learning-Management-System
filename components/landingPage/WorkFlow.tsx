    ...
    <section id="workflow" className="py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-0  h-full w-0.5 -translate-x-1/2 bg-gradient-to-b from-blue-500 via-purple-500 to-indigo-500 opacity-20 hidden sm:block" />
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className={`flex-1 ${index % 2 === 0 ? "text-right" : "text-left"}`}>
                  ...
                  >
                    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 ring-1 ring-white/10">
